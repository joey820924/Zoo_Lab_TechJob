...
class SoftJobPipeline(object):
    def __init__(self):
        DBargs = dict(host = '140.118.110.90',port = 12345,db = 'soft_job',user = 'soft_job',passwd = 'joey820924',charset = "utf8",cursorclass = MySQLdb.cursors.DictCursor,use_unicode=True)
