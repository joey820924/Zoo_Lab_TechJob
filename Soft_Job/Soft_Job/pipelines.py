...
class SoftJobPipeline(object):
    ...
    def insert_into_table(self,conn,item):
            conn.execute('insert into Soft_Job_Table (ID,Title,Author,DateTime,IP,Content,TotalScore,Url) values(%s,%s,%s,%s,%s,%s,%s,%s)', (item['ID'],item['Title'],item['Author'],item['DateTime'],item['IP'],item['Content'],item['Score'],item['Url']))
